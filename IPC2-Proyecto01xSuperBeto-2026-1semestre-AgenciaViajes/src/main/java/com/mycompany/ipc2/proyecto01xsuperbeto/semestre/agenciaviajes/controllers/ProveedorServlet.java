...
public class ProveedorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<JsonObject> proveedores = proveedorDAO.obtenerProveedores();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            String pais = json.get("pais").getAsString();

            String contacto = json.has("contacto") ? json.get("contacto").getAsString() : "";

            boolean exito = proveedorDAO.crearProveedor(nombre, tipo, pais, contacto);
