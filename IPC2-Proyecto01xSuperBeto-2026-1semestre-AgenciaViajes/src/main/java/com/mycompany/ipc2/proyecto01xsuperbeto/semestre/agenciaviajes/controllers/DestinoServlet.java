...
public class DestinoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DestinoServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DestinoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<JsonObject> destinos = destinoDAO.obtenerDestinos();
        resp.getWriter().write(gson.toJson(destinos));
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean exito = destinoDAO.crearDestino(
            json.get("nombre").getAsString(),
            json.get("pais").getAsString(),
            json.get("descripcion").getAsString(),
            json.get("clima_epoca_ideal").getAsString(),
            json.get("imagen_url").getAsString()
        );
